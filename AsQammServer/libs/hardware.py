...
class AqAbstractHardwareUnit:
    ...
    Информация о них находится в hardware.asqd в виде JSON-списка. Там хранятся
    базовые настройки исполнителя, а также информация обо всех подчинённых ему
    модулях и их настройках.
