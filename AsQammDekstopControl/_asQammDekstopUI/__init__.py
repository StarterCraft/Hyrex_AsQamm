...
"QTabBar::tab { padding: 2 14 2 14; min-width: 8ex; }")
        ...
        self.clv_HardwareList = QtWidgets.QColumnView(self.box_Hardware)
        self.clv_HardwareList.setGeometry(QtCore.QRect(6, 22, 520, 200))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.clv_HardwareList.sizePolicy().hasHeightForWidth())
        self.clv_HardwareList.setSizePolicy(sizePolicy)
        self.clv_HardwareList.setStyleSheet("")
        self.clv_HardwareList.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.clv_HardwareList.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.clv_HardwareList.setObjectName("clv_HardwareList")
        self.frame_HardwareActionsPool = QtWidgets.QFrame(self.box_Hardware)
        self.frame_HardwareActionsPool.setGeometry(QtCore.QRect(540, 22, 141, 201))
        self.frame_HardwareActionsPool.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_HardwareActionsPool.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_HardwareActionsPool.setObjectName("frame_HardwareActionsPool")
        self.frame_HardwareUItilPool = QtWidgets.QFrame(self.box_Hardware)
        self.frame_HardwareUItilPool.setGeometry(QtCore.QRect(10, 230, 671, 161))
        self.frame_HardwareUItilPool.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_HardwareUItilPool.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_HardwareUItilPool.setObjectName("frame_HardwareUItilPool")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(10, 114, 181, 23))
...
"QPushButton:pressed { background-color: rgb(70, 175, 38); }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Перезагрузить соединение"))
