...
"QPushButton:pressed { background-color: rgb(70, 175, 38); }")
        ...
        self.btn_AddHardwareUnit = QtWidgets.QPushButton(self.frame_HardwareBasicActions)
        self.btn_AddHardwareUnit.setMinimumSize(QtCore.QSize(78, 48))
        self.btn_AddHardwareUnit.setMaximumSize(QtCore.QSize(64, 48))
        self.btn_AddHardwareUnit.setText("")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/white/white/plus_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_AddHardwareUnit.setIcon(icon11)
        self.btn_AddHardwareUnit.setIconSize(QtCore.QSize(50, 50))
        self.btn_AddHardwareUnit.setObjectName("btn_AddHardwareUnit")
        self.horizontalLayout_11.addWidget(self.btn_AddHardwareUnit)
        self.btn_ConfigureHardwareUnit = QtWidgets.QPushButton(self.frame_HardwareBasicActions)
        self.btn_ConfigureHardwareUnit.setMinimumSize(QtCore.QSize(78, 48))
        self.btn_ConfigureHardwareUnit.setMaximumSize(QtCore.QSize(64, 48))
        self.btn_ConfigureHardwareUnit.setText("")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/white/white/config_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_ConfigureHardwareUnit.setIcon(icon12)
        self.btn_ConfigureHardwareUnit.setIconSize(QtCore.QSize(50, 50))
        self.btn_ConfigureHardwareUnit.setObjectName("btn_ConfigureHardwareUnit")
        self.horizontalLayout_11.addWidget(self.btn_ConfigureHardwareUnit)
        self.btn_ToggleHardwareUnitStatsRegistry = QtWidgets.QPushButton(self.frame_HardwareBasicActions)
        self.btn_ToggleHardwareUnitStatsRegistry.setMinimumSize(QtCore.QSize(78, 48))
        self.btn_ToggleHardwareUnitStatsRegistry.setMaximumSize(QtCore.QSize(64, 48))
        self.btn_ToggleHardwareUnitStatsRegistry.setAutoFillBackground(False)
        self.btn_ToggleHardwareUnitStatsRegistry.setText("")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/white/white/save_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_ToggleHardwareUnitStatsRegistry.setIcon(icon13)
        self.btn_ToggleHardwareUnitStatsRegistry.setIconSize(QtCore.QSize(50, 50))
        self.btn_ToggleHardwareUnitStatsRegistry.setObjectName("btn_ToggleHardwareUnitStatsRegistry")
        self.horizontalLayout_11.addWidget(self.btn_ToggleHardwareUnitStatsRegistry)
        self.btn_DeleteHardwareUnit = QtWidgets.QPushButton(self.frame_HardwareBasicActions)
        self.btn_DeleteHardwareUnit.setMinimumSize(QtCore.QSize(78, 48))
        self.btn_DeleteHardwareUnit.setMaximumSize(QtCore.QSize(64, 48))
        self.btn_DeleteHardwareUnit.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/white/white/deny_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_DeleteHardwareUnit.setIcon(icon14)
        self.btn_DeleteHardwareUnit.setIconSize(QtCore.QSize(50, 50))
        self.btn_DeleteHardwareUnit.setObjectName("btn_DeleteHardwareUnit")
        self.horizontalLayout_11.addWidget(self.btn_DeleteHardwareUnit)
        self.btn_AdditionalHardwareSettings = QtWidgets.QPushButton(self.frame_HardwareBasicActions)
        self.btn_AdditionalHardwareSettings.setMinimumSize(QtCore.QSize(78, 48))
        self.btn_AdditionalHardwareSettings.setMaximumSize(QtCore.QSize(78, 48))
        self.btn_AdditionalHardwareSettings.setText("")
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/white/white/more_ico.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_AdditionalHardwareSettings.setIcon(icon15)
        self.btn_AdditionalHardwareSettings.setIconSize(QtCore.QSize(50, 50))
        self.btn_AdditionalHardwareSettings.setObjectName("btn_AdditionalHardwareSettings")
        self.horizontalLayout_11.addWidget(self.btn_AdditionalHardwareSettings)
