...
class AqServerCommutator:
    def __init__(self, root):
        ...
        self.commutatorLogger = libs.functions.AqLogger('ServerCommutator')

        if jsonString['port']: self.commutatorLogger.info(f'Известный адрес сервера: {self.ip}:{self.port}')
        else: self.commutatorLogger.info(f'Известный адрес сервера: {self.ip}')
