...
class Ui_Dlg_EditCurrentUserInUserDb(object):
    def setupUi(self, Dlg_EditUserInUserDb):
        ...
        Dlg_EditUserInUserDb.resize(400, 285)
...
"}")
    ...
    def retranslateUi(self, Dlg_EditUserInUserDb):
        ...
        self.lnI_EuDesc.setPlaceholderText(_translate("Dlg_EditUserInUserDb", "Укажите описание"))
        ...
        self.lnI_EuAvatarAddr.setPlaceholderText(_translate("Dlg_EditUserInUserDb", "Укажите адрес аватарки"))
        self.lnI_EuPassword.setPlaceholderText(_translate("Dlg_EditUserInUserDb", "Укажите пароль"))
