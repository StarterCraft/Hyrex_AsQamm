...
# Form implementation generated from reading ui file 'uisrc\userCreation.ui'
#
...
"}")
    ...
    def retranslateUi(self, Dlg_CreateNewUserInUserDb):
        ...
        self.lnI_CnuDesc.setPlaceholderText(_translate("Dlg_CreateNewUserInUserDb", "Укажите описние нового пользователя"))
        self.lnI_CnuAvatarAddr.setPlaceholderText(_translate("Dlg_CreateNewUserInUserDb", "Укажите аватарку нового пользователя"))
        self.lbl_CnuID.setText(_translate("Dlg_CreateNewUserInUserDb", "(id)"))
        self.lnI_CnuPassword.setPlaceholderText(_translate("Dlg_CreateNewUserInUserDb", "Укажите пароль нового пользователя"))
        ...
        self.lnI_CnuLogin.setPlaceholderText(_translate("Dlg_CreateNewUserInUserDb", "Укажите логин вашего пользователя"))
